...
func (b *producePartitionResponseBuilder) Build() legacy_kafkaapi.ProducePartitionResponse {
	if b.index == -1 {
		panic("CodeCrafters Internal Error: index must be set before building PartitionResponse")
	}

	return legacy_kafkaapi.ProducePartitionResponse{
		Index:           b.index,
		ErrorCode:       b.errorCode,
		BaseOffset:      b.baseOffset,
		LogAppendTimeMs: -1,
		LogStartOffset:  b.logStartOffset,
		RecordErrors:    []legacy_kafkaapi.ProduceRecordError{},
		ErrorMessage:    nil,
	}
}
