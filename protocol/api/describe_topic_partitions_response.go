...
func (a *DescribeTopicPartitionsResponseTopic) Decode(pd *decoder.Decoder, logger *logger.Logger, indentation int) (err error) {
...
func (d *DescribeTopicPartitionsResponsePartition) Decode(pd *decoder.Decoder, logger *logger.Logger, indentation int) (err error) {
...
func (c *DescribeTopicPartitionsResponseCursor) Decode(pd *decoder.Decoder, logger *logger.Logger, indentation int) error {
	var err error
