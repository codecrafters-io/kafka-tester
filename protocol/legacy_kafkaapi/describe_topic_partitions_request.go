...
func (t TopicName) Encode(pe *legacy_encoder.Encoder) {
...
func (c Cursor) Encode(pe *legacy_encoder.Encoder) {
...
func (r DescribeTopicPartitionsRequestBody) encode(pe *legacy_encoder.Encoder) {
...
func (r DescribeTopicPartitionsRequest) GetHeader() legacy_headers.RequestHeader {
	return r.Header
}
