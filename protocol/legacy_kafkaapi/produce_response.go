...
func (r *ProduceRecordError) decode(rd *legacy_decoder.Decoder, logger *logger.Logger, indentation int) error {
...
func (p *ProducePartitionResponse) decode(rd *legacy_decoder.Decoder, logger *logger.Logger, indentation int) error {
...
func (t *ProduceTopicResponse) decode(rd *legacy_decoder.Decoder, logger *logger.Logger, indentation int) error {
...
func (p *ProduceResponseBody) decode(rd *legacy_decoder.Decoder, logger *logger.Logger, indentation int) error {
	...
	if rd.Remaining() != 0 {
		return legacy_errors.NewPacketDecodingError(fmt.Sprintf("unexpected %d bytes remaining in decoder after decoding ProduceResponseBody", rd.Remaining()))
	}
...
type ProduceResponse struct {
	Header legacy_headers.ResponseHeader
