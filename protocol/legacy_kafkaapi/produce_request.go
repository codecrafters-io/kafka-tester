...
func (p ProducePartitionData) encode(pe *legacy_encoder.Encoder) {
	pe.PutInt32(p.Index)
...
func (t ProduceTopicData) encode(pe *legacy_encoder.Encoder) {
...
func (r ProduceRequestBody) encode(pe *legacy_encoder.Encoder) {
...
func (r ProduceRequest) GetHeader() legacy_headers.RequestHeader {
	return r.Header
}
