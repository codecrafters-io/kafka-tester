...
type ResponseHeaderAssertion struct {
	ActualValue   legacy_headers.ResponseHeader
	ExpectedValue legacy_headers.ResponseHeader
}

func NewResponseHeaderAssertion(actualValue legacy_headers.ResponseHeader, expectedValue legacy_headers.ResponseHeader) *ResponseHeaderAssertion {
