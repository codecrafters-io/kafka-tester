...
type ApiVersionsResponseAssertion struct {
	ActualValue   legacy_kafkaapi.ApiVersionsResponse
	ExpectedValue legacy_kafkaapi.ApiVersionsResponse
}

func NewApiVersionsResponseAssertion(actualValue legacy_kafkaapi.ApiVersionsResponse, expectedValue legacy_kafkaapi.ApiVersionsResponse) *ApiVersionsResponseAssertion {
