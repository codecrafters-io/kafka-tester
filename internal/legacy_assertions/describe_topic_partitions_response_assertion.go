...
type DescribeTopicPartitionsResponseAssertion struct {
	ActualValue             legacy_kafkaapi.DescribeTopicPartitionsResponse
	ExpectedValue           legacy_kafkaapi.DescribeTopicPartitionsResponse
...
func NewDescribeTopicPartitionsResponseAssertion(actualValue legacy_kafkaapi.DescribeTopicPartitionsResponse, expectedValue legacy_kafkaapi.DescribeTopicPartitionsResponse) *DescribeTopicPartitionsResponseAssertion {
...
func (a *DescribeTopicPartitionsResponseAssertion) assertPartitions(expectedPartitions []legacy_kafkaapi.DescribeTopicPartitionsResponsePartition, actualPartitions []legacy_kafkaapi.DescribeTopicPartitionsResponsePartition, topicPartitionIndex int, logger *logger.Logger) error {
