...
type FetchResponseAssertion struct {
	ActualValue             legacy_kafkaapi.FetchResponse
	ExpectedValue           legacy_kafkaapi.FetchResponse
	excludedPartitionFields []string
}

func NewFetchResponseAssertion(actualValue legacy_kafkaapi.FetchResponse, expectedValue legacy_kafkaapi.FetchResponse, logger *logger.Logger) *FetchResponseAssertion {
...
func (a *FetchResponseAssertion) assertPartitions(expectedPartitions []legacy_kafkaapi.PartitionResponse, actualPartitions []legacy_kafkaapi.PartitionResponse, logger *logger.Logger) error {
...
func (a *FetchResponseAssertion) assertRecordBatches(expectedRecordBatches []legacy_kafkaapi.RecordBatch, actualRecordBatches []legacy_kafkaapi.RecordBatch, logger *logger.Logger) error {
...
func (a *FetchResponseAssertion) assertRecords(expectedRecords []legacy_kafkaapi.Record, actualRecords []legacy_kafkaapi.Record, logger *logger.Logger) error {
...
func (a *FetchResponseAssertion) assertRecordBatchBytes(logger *logger.Logger) error {
	actualRecordBatches := legacy_kafkaapi.RecordBatches{}
	...
	expectedRecordBatches := legacy_kafkaapi.RecordBatches{}
	...
	expectedRecordBatchBytes := legacy_serializer.GetEncodedBytes(expectedRecordBatches)
	actualRecordBatchBytes := legacy_serializer.GetEncodedBytes(actualRecordBatches)
