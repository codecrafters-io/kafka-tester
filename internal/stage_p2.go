...
func testProduceWithTopicAndPartitionId(client *instrumented_kafka_client.InstrumentedKafkaClient, stageLogger *logger.Logger, topicName string, partitionId int32) error {
